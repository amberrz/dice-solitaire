...
public class Game {
  ...
  public static final int NUM_SET = 2;
  public static final int NUM_SCRATCH = 1;
  public static final int NUM_DICE = NUM_SCRATCH+NUM_SET * SET_SIZE;
